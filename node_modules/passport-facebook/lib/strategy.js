...
function Strategy(options, verify) {
    ...
    this.name = 'facebook';
    this._profileURL = options.profileURL || 'https://graph.facebook.com/me?fields=name,first_name,last_name,email,gender,bio,hometown,location,username,birthday,friends';
